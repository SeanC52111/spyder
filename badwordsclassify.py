# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 08:10:45 2017
...
emodict = {'like':['like','happiness'],'fear':['fear','surprise'],'disgust':['disgust','anger'],'anger':['disgust','anger'],\
           'surprise':['fear','surprise'],'sadness':['sadness'],'happiness':['like','happiness'],'none':['none']}
...
model.fit(x_train, y_train,batch_size=128,validation_split=0.2,epochs=15)

model.save('my_model.h5')

#model = model = load_model('my_model.h5')
'''
score = model.evaluate(x_train, y_train, batch_size=32,verbose=0) # 评估模型在训练集中的效果，准确率约99%
print('train score:', score[0])
print('train accuracy:', score[1])
score = model.evaluate(x_val, y_val,batch_size=32, verbose=0)  # 评估模型在测试集中的效果，准确率约为97%，迭代次数多了，会进一步提升
print('Test score:', score[0])
print('Test accuracy:', score[1])
'''

'''
pre = model.predict_classes(x_val,verbose=0,batch_size=128)
